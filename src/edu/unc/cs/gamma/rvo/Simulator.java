...
public class Simulator {
    ...
    public int addAgent(Vector2D position, Color color) {
        if (defaultAgent == null) {
            return -1;
        }
    ...
    public Color getAgentColor(int index)
    {
    	return agents.get(index).getColor();
    }
    /**
    ...
    public int getAgentAgentNeighbor(int agentNo, int neighborNo) {
        return agents.get(agentNo).agentNeighbors.get(neighborNo).getValue().id;
    }
    ...
    public int getAgentObstacleNeighbor(int agentNo, int neighborNo) {
        return agents.get(agentNo).obstacleNeighbors.get(neighborNo).getValue().id;
    }
